if minetest.setting_getbool("translate_language")== nil or minetest.setting_getbool("translate_language")=="" then
	minetest.setting_set("translate_language", "BR")
end


local path = minetest.get_modpath(minetest.get_current_modname())
local language = minetest.setting_get("translate_language")
